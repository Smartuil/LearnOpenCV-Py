...
model_bin = "D:/images/models/face_detector/opencv_face_detector_uint8.pb";
config_text = "D:/images/models/face_detector/opencv_face_detector.pbtxt";

# load tensorflow model
net = cv.dnn.readNetFromTensorflow(model_bin, config=config_text)
image = cv.imread("D:/images/persons.png")
h = image.shape[0]
w = image.shape[1]
